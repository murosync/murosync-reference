...
proc update_PARAM_VALUE.IP_VERSION_MAJOR { PARAM_VALUE.IP_VERSION_MAJOR } {
	# Procedure called to update IP_VERSION_MAJOR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IP_VERSION_MAJOR { PARAM_VALUE.IP_VERSION_MAJOR } {
	# Procedure called to validate IP_VERSION_MAJOR
	return true
}

proc update_PARAM_VALUE.IP_VERSION_MINOR { PARAM_VALUE.IP_VERSION_MINOR } {
	# Procedure called to update IP_VERSION_MINOR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.IP_VERSION_MINOR { PARAM_VALUE.IP_VERSION_MINOR } {
	# Procedure called to validate IP_VERSION_MINOR
	return true
}
...
proc update_MODELPARAM_VALUE.IP_VERSION_MAJOR { MODELPARAM_VALUE.IP_VERSION_MAJOR PARAM_VALUE.IP_VERSION_MAJOR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IP_VERSION_MAJOR}] ${MODELPARAM_VALUE.IP_VERSION_MAJOR}
}

proc update_MODELPARAM_VALUE.IP_VERSION_MINOR { MODELPARAM_VALUE.IP_VERSION_MINOR PARAM_VALUE.IP_VERSION_MINOR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.IP_VERSION_MINOR}] ${MODELPARAM_VALUE.IP_VERSION_MINOR}
}
