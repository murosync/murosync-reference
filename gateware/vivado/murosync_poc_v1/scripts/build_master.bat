...
REM # File       : build_master.bat
REM # Created    : 2026-05-24
REM # Author     : Mikhail Vasilev
REM #
REM # Description:
REM #   Windows batch wrapper that invokes Vivado in batch mode to build the
REM #   MASTER bitstream variant of the murosync_poc_v1 project.
REM #
REM #   Sets up paths to the Vivado executable and the build_bitstream.tcl
REM #   script, then launches the build with -tclargs MASTER. After the build
REM #   completes (or fails) the window pauses so the user can inspect output.
REM #
REM # Usage:
REM #   Double-click in Explorer, or run from CMD: build_master.bat
REM #
REM # Output:
REM #   C:\_vivado\murosync_poc_v1\bitstreams\murosync_MASTER.bit
REM #   C:\_vivado\murosync_poc_v1\bitstreams\murosync_MASTER.xsa
REM #
REM # Notes:
